...
public class UserController {
	...
	public String register(@ModelAttribute("user") User user) {
		LOGGER.info("Inside the  USERREPOSITORY: " + user);
	...
	public String login(@RequestParam("email")String email, @RequestParam("password")String password, ModelMap modelMap) {
		...
		LOGGER.info("Inside the  LOGIN and the EMAIL is: " + email);

	
		if(loginResponse) {
			return "findFlights";
		}else {
			modelMap.addAttribute("msg", "Invalid User Name or Password. Ayusin mo LODI!");
